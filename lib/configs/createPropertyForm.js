...
import { formatMoneyVal } from '../formatMoney';
import { HEALTHY_HOMES_ASSESSMENT_COST } from '../configs/costings';
import moment from 'moment';
import { COMPANY_LEGAL_NAME, COMPANY_NAME } from '@/Lib/const';

const healthyHomesCost = formatMoneyVal(HEALTHY_HOMES_ASSESSMENT_COST);
    ...
    inners: [
        ...
        inners: [
          {
            ...
            inners: [
              ...
              },
              {
                ...
                content: `${COMPANY_NAME} completes a Healthy Homes Assessment for ${healthyHomesCost}`,
                refConf: {},
              },
              {
                type: 'Entity',
              ...
              },
              {
                type: 'Info',
                parentShowVals: ['REHOUSER'],
                content: `${COMPANY_NAME} will make sure you have an insulation statement`,
                refConf: {},
              },
            ],
          },
      ...
      },
      {
        ...
        inners: [
          {
            type: 'RTypography',
            content: `If you would like ${COMPANY_NAME} to pay these bills please let us know and we will be in contact to discuss this further.`,
            fieldProps: {
              variant: 'body1',
            },
          },
        ...
        inners: [
          {
            ...
            fieldProps: {
              ...
              name: 'images',
              label: 'Images',
              description: `It is not necessary to upload photos of your property as that will be completed by ${COMPANY_NAME}.`,
