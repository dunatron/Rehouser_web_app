...
const LANDLORD_TERMS_OF_ENGAGEMENT_FORM_CONF = [
  {
    type: 'Header',
    fieldProps: {
      label: 'Accept Terms of Engagement Form',
    },
  },
  // {
  //   type: 'Location',
  ...
  // },
  {
    ...
    refConf: {
      required: {
        value: true,
        message: 'You to supply your billing address',
      },
    },
  },
  {
    ...
    refConf: {
      required: {
        value: true,
        message: 'You need to upload a file that proves you own the property',
      },
    },
  },
  {
    ...
    inners: [
      ...
      },
      {
        ...
        fieldProps: {
          ...
          label: `I Accept ${COMPANY_LEGAL_NAME} terms of Engagement`,
          helperText: 'your bank account to pay profits into',
        },
        refConf: {
          required: {
  ...
  {
    type: 'RTypography',
    content: `Signed by Heath McDonough, ${COMPANY_NAME} Property Manager`,
    fieldProps: {
      variant: 'body1',
    },
  },
