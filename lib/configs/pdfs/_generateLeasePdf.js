...
const _generateLeasePdfConf = lease => {
  ...
  const rentDollarAmount = formatMoneyVal(lease.rent);
  const bondDollarAmount = formatMoneyVal(
        ...
        },
        {
          ...
          inners: [
            ...
            },
            {
              ...
              listStyle: 'number',
              listNum: 'c.',
              value: `Notice given to the tenant may be sent by text message service, messenger service on ${COMPANY_NAME} Platform or email.`,
              fieldProps: { variant: 'body2' },
              layoutProps: { variant: 'left' },
            },
          ],
