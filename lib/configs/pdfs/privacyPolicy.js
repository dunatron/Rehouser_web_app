...
const config = [
  {
    ...
    inners: [
      ...
      },
      {
        type: 'Text',
        value:
          `This Privacy Policy describes how ${COMPANY_LEGAL_NAME} and its affiliates ("${COMPANY_NAME},", "we, "our", or "us") collect, use and share information ` +
          `in connection with your use of our websites (including ${APP_SHORT_URL}), services, and applications.`,
        fieldProps: {
          variant: 'body1',
        },
        layoutProps: {
      ...
      },
      {
        type: 'Text',
        value:
          `We recommend that you read this Privacy Policy in full, including the Additional Disclosures referenced at the bottom of this document,
           to ensure you are fully informed. If you have any questions about this Privacy Policy or ${COMPANY_NAME}'s data collection, use, and disclosure practises, please ` +
          `contact us at ${CEO.email}`,
        fieldProps: {
          variant: 'body1',
        },
        layoutProps: {
        ...
        inners: [
          {
            type: 'Li',
            listStyle: 'bullet',
            value: 'Provide, operate, and maintain our Services',
            fieldProps: {
              variant: 'body1',
            },
            layoutProps: {
  ...
  },
  {
    ...
    inners: [
      {
        type: 'Text',
        value: '3. How We Share Information',
        fieldProps: {
          variant: 'h2',
        },
        layoutProps: {
  ...
  },
  {
    ...
    inners: [
      ...
      {
        type: 'Text',
        value: `To protect your privacy and security, we may also take reasonable steps to verify your 
        identity before updating or removing your information. The information you provide us may be archived 
        or stored periodically by us according to backup processes conducted in the ordinary course of business for disaster recovery purposes. Your ability to access and correct your information may be temporarily limited where access and correction 
        could: inhibit ${COMPANY_NAME}'s ability to comply with a legal obligation; inhibit ${COMPANY_NAME}'s ability to investigate, 
        make or defend legal claims; result in disclosure of personal information about a third party; or result in breach of a contract or disclosure of trade secrets or other proprietary business information belonging to ${COMPANY_NAME} or a third party.`,
        fieldProps: {
          variant: 'body1',
        },
        layoutProps: {
